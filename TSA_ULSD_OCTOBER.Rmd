...
p1 <-
  ...
  ggplot(aes(x = date, y = value, color = param),width = 700, height = 400) +
  geom_line() +
  scale_y_continuous(labels = scales::comma) +
  ggtitle(fig.title)
...
p2 <-
  ...
  ggplot(aes(x = date, y = value, color = product),width = 700, height = 400) +
  geom_line() +
...
pj <- df_join %>% 
  ...
  ggplot(
  aes(x = date, y = value, col = series),width = 700, height = 400)+
  geom_line()+ggtitle(fig.title)

pj %>% plotly::ggplotly(width = 700, height = 400,)
...
ps %>%  plotly::ggplotly(width = 700, height = 400,)
```
...
p3 %>% plotly::ggplotly(width = 700, height = 400,)
```
...
```{r}
pja <- df_join_all %>%
  ggplot(aes(x = spread, y = HO_Crack_Spd, col = date),width = 700, height = 400) +
  geom_point() +
...
pja %>% plotly::ggplotly(width = 700, height = 400,)
```
